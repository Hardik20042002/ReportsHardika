...
const map = new Map([
  ...
  const dummy=new Map([
    ...
    ['jaiambeyent','JAI AMBEY COMMUNICATION ENTERPRISES ! DADRI'],
    ['jaiambeyenterprises','JAI AMBEY COMMUNICATION ENTERPRISES ! DADRI'],
    ['jaiambeycommunicationenterprises','JAI AMBEY COMMUNICATION ENTERPRISES ! DADRI'],
    ['jaiambeent','JAI AMBEY COMMUNICATION ENTERPRISES ! DADRI'],
    ...
    ['mahalaxmis','MAHALAXMI MOBILE STORE ! DADRI'],
    ['mahalaxmimobilestore','MAHALAXMI MOBILE STORE ! DADRI'],
    ['mahalaxmistore','MAHALAXMI MOBILE STORE ! DADRI'],
    ['matrix','MATRIX NETWORK MOBILE STORE ! GREATER NOIDA'],
    ['matrixmobilestore','MATRIX NETWORK MOBILE STORE ! GREATER NOIDA'],
    ['hotspot','MOBILE HOTSPOT ! DADRI'],
    ['mobilehotspot','MOBILE HOTSPOT ! DADRI'],
    ['mobilehotspot','MOBILE HOTSPOT ! DADRI'],
    ...
    ['sachin','SACHIN TELECOM AND MOBILE SHOP ! DADRI'],
    ['sachintelecomandmobileshop','SACHIN TELECOM AND MOBILE SHOP ! DADRI'],
    ['sanchar','SANCHAR BHAWAN (GREATER NOIDA) ! GREATER NOIDA'],
    ['sancharbhawan','SANCHAR BHAWAN (GREATER NOIDA) ! GREATER NOIDA'],
    ['satnam','SATNAM MOBILE STORE ! HALDAUNI ! G B NAGAR'],
    ['satnammobilestore','SATNAM MOBILE STORE ! HALDAUNI ! G B NAGAR'],
    ...
    ['vishal','VISHAL MOBILE HOUSE ! DADRI'],
